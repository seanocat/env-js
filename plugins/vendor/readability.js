...
var readability = {
    ...
    init: function() {
        ...
        dbg('caching document body');
        if(document.body && !readability.bodyCache) {
            readability.bodyCache = document.body.cloneNode(true); }
        dbg('finished caching document body');
        
        dbg('preping document');
        readability.prepDocument();
        dbg('finished preping document');
        ...
        **/
        if(readability.getInnerText(articleContent, false).length < 250)
        {
            if (readability.flagIsActive(readability.FLAG_STRIP_UNLIKELYS)) {
                ...
                document.body = readability.bodyCache;
...
//        document.body.style.display = "block";
	...
	**/
    ...
    prepDocument: function () {
        ...
        /* Thatcher: edited for some optimization in envjs */
        /*document.body.innerHTML = readability.bodyCache ? 
            readability.bodyCache.
